...
| :---------------- | :---------------: | ------------------: |
|Open the application on the terminal | Run the command ```$ python3.9 run.py```|Hello there Welcome to Password Locker <br>* NA ---  Create New Account * LG ---  LogIn (Have An Account) |
